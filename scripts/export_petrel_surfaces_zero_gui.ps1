...
$pythonScript = Join-Path $scriptDir "export_petrel_surfaces_zero_gui.py"
...
if (-not (Test-Path -LiteralPath $pythonScript -PathType Leaf)) {
    throw "Zero-GUI surface exporter not found: $pythonScript"
}
...
& $pythonExe $pythonScript --export-package $ExportPackage
