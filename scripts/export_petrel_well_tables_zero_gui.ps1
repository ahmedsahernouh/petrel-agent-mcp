...
$pythonScript = Join-Path $scriptDir "export_petrel_well_tables_zero_gui.py"
...
if (-not (Test-Path -LiteralPath $pythonScript -PathType Leaf)) {
    throw "Zero-GUI well table exporter not found: $pythonScript"
}
...
& $pythonExe $pythonScript `
    ...
    --max-native-xml-rows $MaxNativeXmlRows
